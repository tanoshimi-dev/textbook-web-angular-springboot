    ...
    template: `
        <div class="container">
            ...
            <div class="filter-buttons">
                ...
                <button
                    class="btn btn-primary"
                    (click)="filterByCategory('Pastry')"
                    [class.active]="selectedCategory === 'Pastry'"
                >
                    Pastry
                </button>
                <button
                    class="btn btn-primary"
                    (click)="filterByCategory('Sandwich')"
